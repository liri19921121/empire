package com.research.wx.sdk;

import com.research.wx.sdk.WXPayConstants.SignType;
...
public class WXPay
{
            ...
            throws Exception
    {
        ...
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix,
            msgUUID,
            reqBody,
            connectTimeoutMs,
            readTimeoutMs,
            ...
            throws Exception
    {
        ...
        String resp = this.wxPayRequest.requestWithCert(urlSuffix,
            msgUUID,
            reqBody,
            connectTimeoutMs,
            readTimeoutMs,
        ...
        throws Exception
    {
        ...
        String respStr =
            this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs).trim();
