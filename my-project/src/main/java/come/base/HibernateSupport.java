...
{
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(HibernateSupport.class);
    ...
    public int mappingQueryCount(String name, Object... objs)
    {
        ...
        return ((Long)fillQuery(getSession().getNamedQuery(name), objs).uniqueResult()).intValue();
        
    }
    
    public List<?> query(String hql, boolean cache, Object... params)
    {
        return fillQuery(getSession().createQuery(hql), params).setCacheable(cache).list();
    }
     ...
     */
    public int deleteSelected(Class<?> clazz, Class<?> type, Serializable... ids)
     ...
     * @throws InstantiationException
     */
    public int deleteSelected(Serializable... entitys)
        throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException,
        InstantiationException
    {
        
        Field field = entitys[0].getClass().getDeclaredField(configuration
            .getClassMapping(entitys[0].getClass().getName()).getTable().getPrimaryKey().getColumn(0).getName());
    ...
    public int deleteSelected(Collection<?> collection)
        ...
        InstantiationException
    {
        ...
        Field field = t.getClass().getDeclaredField(
            configuration.getClassMapping(t.getClass().getName()).getTable().getPrimaryKey().getColumn(0).getName());
        field.setAccessible(true);
    ...
    {
        List<Object> list = (List<Object>)find(hql, params);
    ...
    {
        sql = sql.toLowerCase();
        return (T)((SQLQuery)fillQuery(getSession().createSQLQuery(sql), params)).addEntity(clazz).uniqueResult();
    }
    
    public Object findObjectBySql(String sql, Object... params)
    {
        //    	sql = sql.toLowerCase();
        return fillQuery(getSession().createSQLQuery(sql), params).uniqueResult();
    }
    
    public Object findObjectBySql1(String sql, Object... params)
    {
        return fillQuery(getSession().createSQLQuery(sql), params).uniqueResult();
    }
    ...
    {
        sql = sql.toLowerCase();
        return ((SQLQuery)fillQuery(getSession().createSQLQuery(sql), params)).addEntity(clazz).list();
    }
    
    public <T> List<T> findBySql1(String sql, Class<T> clazz, Object... params)
    {
        return ((SQLQuery)fillQuery(getSession().createSQLQuery(sql), params)).addEntity(clazz).list();
    }
    ...
    {
        return fillQuery(getSession().createQuery(hql), params).executeUpdate();
    }
    
    public int executeSql(String sql, Object... params)
    {
        sql = sql.toLowerCase();
        return fillQuery(getSession().createSQLQuery(sql), params).executeUpdate();
    }
     ...
     * @return 实体对象集合
     */
    public List pageListByHql(PageModel page, String hqlCount, String hqlInfo, boolean cache, Object... params)
    {
        Session session = getSession();
        ...
        return fillQuery(session.createQuery(hqlInfo), params).setMaxResults(page.getPagePerSize())
     ...
     * @return 实体对象集合
     */
    public List pageListByHql(PageModel page, String hql, boolean cache, Object... params)
    {
     ...
     */
    public List pageListBySql(PageModel page, String sqlCount, String sqlInfo, Class<?> clazz, Object... params)
    {
     ...
     * @return 实体对象集合(若clazz为null,则为数组集合)
     */
    public List pageListBySql(PageModel page, String sql, Class<?> clazz, Object... params)
    {
    ...
    public List<?> pageListByHql(Pager page, String hqlCount, String hqlInfo, boolean cache, Object... params)
    {
        Session session = getSession();
        ...
        return fillQuery(session.createQuery(hqlInfo), params).setMaxResults(page.getNumPerPage())
            .setFirstResult((page.getPageNum() - 1) * page.getNumPerPage())
            .setCacheable(cache)
            .list();
    }
    
    public List<?> pageListByHql(Pager page, String hql, boolean cache, Object... params)
    {
        return pageListByHql(page, getCount(hql), hql, cache, params);
    }
    
    public List<?> pageListBySql(Pager page, String sqlCount, String sqlInfo, Class<?> clazz, Object... params)
    {
        Session session = getSession();
    ...
    public List<?> pageListBySql(Pager page, String sql, Class<?> clazz, Object... params)
    {
        return pageListBySql(page, getCount(sql), sql, clazz, params);
    }
    ...
    public ResultSet callProcedureResultSet(String procedureName, Object... params)
    {
        ...
        try
        {
            ...
            cs = getConnection().prepareCall(bornExecuteProcedureStr(procedureName, params));
    ...
    public CachedRowSet callProcedureCachedRowSet(String procedureName, Object... params)
    {
    ...
    public Object callProcedureOutput(String procedureName, Object... params)
    {
        ...
        try
        {
            ...
            cs = getConnection().prepareCall(bornExecuteProcedureStr(procedureName, params));
            cs.registerOutParameter(params.length, Integer.parseInt(params[params.length - 1].toString()));
    ...
    public boolean callProcedureVoid(String procedureName, Object... params)
    {
        try
        {
            return !installParams(getConnection().prepareCall(bornExecuteProcedureStr(procedureName, params)), params)
                .execute();
        }
        catch (SQLException e)
        {
     ...
     *             SQL异常
     */
    private CallableStatement installParams(CallableStatement cs, Object[] params)
        throws SQLException
    {
    ...
    private String bornExecuteProcedureStr(String procedureName, Object[] params)
    {
        ...
        StringBuilder procedureStr = new StringBuilder("{CALL ").append(procedureName);
        if (params != null && params.length > 0)
        {
            procedureStr.append("(?");
        ...
        for (int i = 1; i < params.length; i += 2)
        {
            if (null != params[i])
            {
                ...
                if (params[i] instanceof Object[])
                {
                    ...
                    query.setParameterList((String)params[i - 1], (Object[])params[i]);
                    
                }
                else if (params[i] instanceof Collection)
                {
                    
                    query.setParameterList((String)params[i - 1], (Collection)params[i]);
     ...
     *             SQL异常
     */
    public PreparedStatement fillPreparedStatement(PreparedStatement preparedStatement, Object... params)
        throws SQLException
    {
    ...
    private Double queryNumber(List list)
    {
        ...
        if (list != null && list.size() == 1 && list.get(0) != null
            && Validate.emptyStringValidate((str = list.get(0).toString())))
        {
