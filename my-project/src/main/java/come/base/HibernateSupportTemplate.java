...
public interface HibernateSupportTemplate extends HibernateOperations
{
     ...
     *             可能有外键关联导致的删除失败
     */
    int deleteSelected(Collection<?> collection)
     ...
     * @return          集合
     */
    <T> List<T> findBySql1(String sql, Class<T> clazz, Object... params);
     ...
     * @return 离线结果集
     */
    CachedRowSet callProcedureCachedRowSet(String procedureName, Object... params);
     ...
     * @return          实体对象集合
     */
    List<?> pageListByHql(Pager page, String hqlCount, String hqlInfo, boolean cache, Object... params);
     ...
     * @return          实体对象集合
     */
    List<?> pageListByHql(Pager page, String hql, boolean cache, Object... params);
     ...
     * @return          实体对象集合
     */
    List<?> pageListBySql(Pager page, String sqlCount, String sqlInfo, Class<?> clazz, Object... params);
     ...
     * @return          实体对象集合
     */
    List<?> pageListBySql(Pager page, String sql, Class<?> clazz, Object... params);
