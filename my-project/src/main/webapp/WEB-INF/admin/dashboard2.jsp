...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/resource/index/cleanzone/js/jquery.easypiechart/jquery.easy-pie-chart.css" />
	...
	<link rel="stylesheet" type="text/css" href="/resource/index/cleanzone/js/intro.js/introjs.css" />
  <link rel="stylesheet" href="/resource/index/cleanzone/js/jquery.vectormaps/jquery-jvectormap-1.2.2.css" type="text/css" media="screen"/>
	<link rel="stylesheet" type="text/css" href="/resource/index/cleanzone/js/jquery.magnific-popup/dist/magnific-popup.css" />
  <link rel="stylesheet" type="text/css" href="/resource/index/cleanzone/js/jquery.niftymodals/css/component.css" />
  <link rel="stylesheet" type="text/css" href="/resource/index/cleanzone/js/bootstrap.summernote/dist/summernote.css" />
...
<body>
  ...
  <div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    ...
    <ul class="nav navbar-nav navbar-right user-nav">
      <li class="dropdown profile_menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="/resource/index/cleanzone/images/avatar2.jpg" /><span>李大大大太阳</span> <b class="caret"></b></a>
        <ul class="dropdown-menu">
            ...
            <ul class="cl-vnavigation">
              <li><a href="#"><i class="fa fa-home"></i><span>仪表盘</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="dashboard2.html"><span class="label label-primary pull-right">New</span> Version 2</a></li>
                </ul>
              </li>
		...
		<div class="container-fluid" id="pcont">
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="content">
                ...
                <a class="image-zoom" src="/resource/index/cleanzone/images/gallery/img4.jpg"><img src="/resource/index/cleanzone/images/gallery/img4.jpg" class="img-thumbnail" style="height:64px;" /></a>
                <a class="image-zoom" src="/resource/index/cleanzone/images/gallery/img6.jpg"><img src="/resource/index/cleanzone/images/gallery/img6.jpg" class="img-thumbnail" style="height:64px;" /></a>
              </div>
            </li>
            <li>
            ...
            <li><i class="fa fa-globe purple"></i><span class="date">5 Jan</span><div class="content"><p><strong>María</strong> This is a message for you in your birthday.</p></div></li>
              ...
              <div class="list-group tickets">
                 ...
                 <span class="label label-primary pull-right">Normal</span> <img class="avatar" src="/resource/index/cleanzone/images/avatar_50.jpg"/> 
                  <h4 class="name">李大大大太阳</h4>
                  <p>My vMaps plugin doesn't work</p> 
                  <span class="date">17 Feb</span>
                </li>
							  <li class="list-group-item" href="#">
                 <span class="label label-danger pull-right">Urgent</span> <img class="avatar" src="/resource/index/cleanzone/images/avatar4_50.jpg"/> 
                  <h4 class="name">Jhon Doe</h4>
                  <p>My vMaps plugin doesn't work</p> 
                  <span class="date">15 Feb</span>
                </li>
							  <li class="list-group-item" href="#">
                 <span class="label label-warning pull-right">Medium</span> <img class="avatar" src="/resource/index/cleanzone/images/avatar1_50.jpg"/> 
          ...
          <div class="block-flat">
            <div class="content no-padding">
              <span class="pull-right">February 15 - 30</span>
              <h4 class="title">Tickets Summary</h4>
              <div class="list-group tickets">
							  <li class="list-group-item" href="#">Unread <span class="badge badge-primary">20</span></li>
							  <li class="list-group-item" href="#">Open Tickets <span class="badge badge-success">35</span></li>
							  <li class="list-group-item" href="#">Closed Tickets <span class="badge">45</span></li>
							</div>	            
            </div>
          </div>
							...
							<table class="no-border">
								...
								<tbody class="no-border-y">
									<tr>
										...
										<td class="text-right"><input class="switch" checked data-size="small" name="op1" type="checkbox" checked /></td>
									</tr>
									<tr>
  ...
  <script src="/resource/index/cleanzone/js/skycons/skycons.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="/resource/index/cleanzone/js/jquery.niftymodals/js/jquery.modalEffects.js"></script>   
    <script type="text/javascript" src="/resource/index/cleanzone/js/bootstrap.summernote/dist/summernote.min.js"></script>

  <script src="/resource/index/cleanzone/js/jquery.vectormaps/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-us-merc-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-fr-merc-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-uk-mill-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-us-il-chicago-mill-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-au-mill-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-in-mill-en.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-map.js"></script>
    <script src="/resource/index/cleanzone/js/jquery.vectormaps/maps/jquery-jvectormap-ca-lcc-en.js"></script>
  ...
  <!-- Bootstrap core JavaScript
    ...
    <script type="text/javascript">
      $(document).ready(function(){
    	...
    	<script type="text/javascript" src="/resource/index/cleanzone/js/jquery.magnific-popup/dist/jquery.magnific-popup.min.js"></script>
