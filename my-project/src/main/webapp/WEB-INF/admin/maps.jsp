...
<!-- Mirrored from condorthemes.com/cleanzone/maps.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:37:27 GMT -->
<head>
    <meta charset="utf-8">
          ...
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-map-marker nav-icon"></i><span>Maps</span></a>
                <ul class="sub-menu">
                  <li class="active"><a href="maps.html">Google Maps</a></li>
			...
			<div class="row">
				<div class="col-sm-6 col-md-6">
					<div class="block-flat">
						...
						<div class="content" id="map_one" style="height: 300px;">
				...
				<div class="col-sm-6 col-md-6">
					...
					<div class="block-flat">
						...
						<div class="content" id="map_two" style="height: 300px;">
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="block-flat">
						...
						<div class="content" id="map_three" style="height: 350px;">
						</div>
					</div>				
				</div>
			</div>
