...
<head>
		...
		<title>关于 | 李太阳博客</title>
		<meta name="author" content="李太阳(yadong.zhang0415#gmail.com)">
		<meta name="keywords" content="李太阳博客,关于博客">
		<meta name="description" content="一个程序员的个人博客,关于我的个人原创博客 - 李太阳博客" id="meta_description">
		<link rel="canonical" href="https://www.zhyd.me/about">
			...
			<div class="menu-box">
				<div class="pull-left">
					<ul class="list-unstyled list-inline">
						<li><span id="currentTime">2018年04月11日 09时44分28秒 星期三</span></li>
					</ul>
					<div class="clear"></div>
				</div>
		...
		<nav id="mainmenu" class="navbar navbar-default navbar-fixed-top" role="navigation" style="top: 30px; z-index: 998;">
			<div class="menu-box">
				<div class="navbar-header">
					...
					<a class="navbar-brand logo" href="/blog//blog/index"></a>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-12 blog-main">
					<div class="blog-body expansion">
						...
						<div class="info">
							<p>
								10多年寒窗过来的。高中时我班长兼信息技术科课代表，也算由此开始了我与软件开发之间的缘分之路。大学主修Java方向，在校两年，两年下来自我感觉还不错，第三年下半学期去实习。 还好，进了GLD在山东的研发分公司，因为是校招，基础工资不算高（但是大公司节日福利很不错），干了将近一年。后来因为女朋友来了北京，所以在去年10月份索性辞了工作，直接来了帝都。
							</p>
							<p>
							...
							<blockquote style="overflow: hidden">
								人生不过几十载， 又能几次重头来。 本就匆匆过路客， 缘何俗事惹自哀？
								<br> 世人笑我太痴呆， 我笑他人实不该。 不被凡尘俗事扰， 且安且得且自在。
								<br>
							</blockquote>
						</div>
						<h5 class="legend-title">关于博客</h5>
						<div class="info">
							构思于<kbd>2016年10月</kbd>中旬，上线于<kbd>2016年10月27日</kbd>。本站为非商业化站点，无盈利性质，为博主个人博客。 本站所有标注为原创的文章，皆为站长亲自创作，因能力有限，可能部分内容并不能引起各位共鸣，若各位有那么一丝丝的空闲时间，劳烦各位能将我文章或者网站不足的地方提出来。
						...
						<div class="info">
							本站大多数文章为站长原创，可能会有少部分文章系从互联网上转载过来的。一般能确认原创出处的，都会在文章中注明。但若因此造成侵权行为，烦请原作者
							<a target="_blank" href="mailto:yadong.zhang0415@gmail.com" title="" data-toggle="tooltip" data-placement="bottom" rel="external nofollow" data-original-title="点击给我发邮件"><strong>告知</strong></a>，我会立刻删除相关内容。
						</div>
						<div class="alert alert-warning alert-dismissible simple-alert fade-in" role="alert">
							<strong>注!</strong> 如果您觉得我的网站能够帮助到您，请您多多支持。我的支付宝账号：<span class="label label-success">1602008388#qq.com</span>（#==@）！ 扫码点击：
							<a class="btn btn-danger btn-sm reward" onclick="PaymentUtils.show();">打赏</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row" style="padding: 4px;padding-left: 10px;">
						...
						<div class="col-xs-12 col-sm-5 col-md-5">
							<a href="/resource/img/blog/qq_group.png" class="showImage" title="QQ群(190886500)二维码" rel="external nofollow">
								<img data-original="/resource/img/blog/qq_group.png" alt="QQ群(190886500)二维码" class="img-responsive img-rounded auto-shake lazy-img" style="width: 100px; display: block;" src="/resource/img/blog/qq_group.png">
							</a>
						</div>
					</div>
				</div>
