...
<title>资享科技</title>
	...
	<!-- Custom CSS -->
    <link rel="stylesheet" href="/resource/index/videoIndex/css/style.css">
	
	<!-- Owl Carousel Assets -->
    <link href="/resource/index/videoIndex/css/owl.carousel.css" rel="stylesheet">
    <link href="/resource/index/videoIndex/css/owl.theme.css" rel="stylesheet">
    ...
    <script src="/resource/index/videoIndex/js/bootstrap.min.js"></script>
...
<!-- 	<nav id="top">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<strong>欢迎来到影享社区!</strong>
				</div>
				<div class="col-md-6 col-sm-6">
					<ul class="list-inline top-link link">
						<li><a href="/welcome/index"><i class="fa fa-home"></i> 首页</a></li>
						<li><a href="/welcome/contact"><i class="fa fa-comments"></i> 联系社主</a></li>
				...
				<ul class="nav navbar-nav">
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="/welcome/archive">Login</a></li>
									<li><a href="/welcome/archive">Register</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-play-circle-o"></i> Video</a>
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="/welcome/archive">Text 201</a></li>
									<li><a href="/welcome/archive">Text 202</a></li>
									<li><a href="/welcome/archive">Text 203</a></li>
									<li><a href="/welcome/archive">Text 204</a></li>
									<li><a href="/welcome/archive">Text 205</a></li>
								</ul>
							</div> 
						</div>
					</li>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-list"></i> Category</a>
						<div class="dropdown-menu" style="margin-left: -203.625px;">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="/welcome/archive">Text 301</a></li>
									<li><a href="/welcome/archive">Text 302</a></li>
									<li><a href="/welcome/archive">Text 303</a></li>
									<li><a href="/welcome/archive">Text 304</a></li>
									<li><a href="/welcome/archive">Text 305</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="/welcome/archive">Text 306</a></li>
									<li><a href="/welcome/archive">Text 307</a></li>
									<li><a href="/welcome/archive">Text 308</a></li>
									<li><a href="/welcome/archive">Text 309</a></li>
									<li><a href="/welcome/archive">Text 310</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="/welcome/archive">Text 311</a></li>
									<li><a href="/welcome/archive">Text 312</a></li>
									<li><a href="/welcome/archive#">Text 313</a></li>
									<li><a href="/welcome/archive#">Text 314</a></li>
									<li><a href="/welcome/archive">Text 315</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li><a href="/welcome/archive"><i class="fa fa-cubes"></i> Blocks</a></li>
					<li><a href="/welcome/contact"><i class="fa fa-envelope"></i> 联系社主</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="header-slide">
		<div id="owl-demo" class="owl-carousel">
			<c:forEach items="${bannerMovieList}" var="list"   varStatus="status">
				<div class="item" >
					<div class="zoom-container">
						<div class="zoom-caption">
							<span>五星推荐</span>
							<a href="/welcome/single?movieName=${list.movieName}">
...
<!-- Header -->
			...
			<div class="row">
				<div class="featured">
					<div class="main-vid">
						<div class="col-md-6">
							<div class="zoom-container">
							    <c:forEach items="${firstMovie}" var="list"   varStatus="status">
									<div class="zoom-caption">
												<span>今日推荐</span>
												<a href="/welcome/single?movieName=${list.movieName}">
													<i class="fa fa-play-circle-o fa-5x" style="color: #fff"></i>
									...
									<img src="/resource/img/movie/first/first.jpg" />
								</c:forEach>
							</div>
						</div>
					</div>
					<div class="sub-vid">
						<div class="col-md-3">
						    <c:forEach items="${sesondMovie}" var="list"   varStatus="status" begin="0" end="1">
								<div class="zoom-container">
									<div class="zoom-caption">
										<span>最新上线</span>
										<a href="/welcome/single?movieName=${list.movieName}">
									...
									<img src="${list.sesondUrl}" />
								</div>
							</c:forEach>
						</div>
						<div class="col-md-3">
							<div class="zoom-container">
							  <c:forEach items="${sesondMovie}" var="list"   varStatus="status" begin="2" end="3">
								<div class="zoom-container">
									<div class="zoom-caption">
										<span>最新上线</span>
										<a href="/welcome/single?movieName=${list.movieName}">
						...
						<div class="box-content">
							<div class="row">
								<div class="col-md-6">
									<div class="wrap-vid">
										<div class="zoom-container">
											<div class="zoom-caption">
												...
												<a href="/welcome/single">
													<i class="fa fa-play-circle-o fa-5x" style="color: #fff"></i>
												</a>
												<p>Video's Name</p>
											</div>
											<img src="/resource/index/videoIndex/images/7.jpg" />
										</div>
									...
									<a href="/welcome/single" class="btn btn-1">Read More</a>
									<div class="line"></div>
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/8.jpg" />
										</div>
										<div class="wrapper">
									...
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/9.jpg" />
										</div>
										<div class="wrapper">
											<h5 class="vid-name"><a href="#">Video's Name</a></h5>
											<div class="info">
									...
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/6.jpg" />
										</div>
										<div class="wrapper">
											<h5 class="vid-name"><a href="#">Video's Name</a></h5>
											<div class="info">
								...
								<div class="col-md-6">
									...
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/4.jpg" />
										</div>
										<div class="wrapper">
											<h5 class="vid-name"><a href="#">Video's Name</a></h5>
											<div class="info">
									...
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/5.jpg" />
										</div>
										<div class="wrapper">
											<h5 class="vid-name"><a href="#">Video's Name</a></h5>
											<div class="info">
									...
									<div class="post wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/2.jpg" />
										</div>
										<div class="wrapper">
											<h5 class="vid-name"><a href="#">Video's Name</a></h5>
											<div class="info">
								...
								<div class="col-md-4">
									<div class="wrap-vid">
										<div class="zoom-container">
											...
											<img src="/resource/index/videoIndex/images/3.jpg" />
										</div>
										<h3 class="vid-name"><a href="#">Video's Name</a></h3>
										<div class="info">
											<h5>By <a href="#">Kelvin</a></h5>
				...
				<div id="sidebar" class="col-md-4">
					...
					<div class="widget wid-follow">
						...
						<div class="content">
							...
							<img src="/resource/index/videoIndex/images/banner.jpg" />
						</div>
						<div class="line"></div>
					</div>
					<!---- Start Widget ---->
					...
					<div class="widget wid-post">
						...
						<div class="content">
							<div class="post">
								<a href="/welcome/single">
									<img src="/resource/index/videoIndex/images/user.png" />
								</a>
								<div class="wrapper">
					...
					<div class="widget wid-banner">
						<img src="/resource/index/videoIndex/images/banner-2.jpg" />
					</div>
				</div>
			</div>
		</div>
	...
	<!-- JS -->
	<script src="/resource/index/videoIndex/js/owl.carousel.js"></script>
    <script>
