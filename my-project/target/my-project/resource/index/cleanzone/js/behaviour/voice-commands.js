...
if(('webkitSpeechRecognition' in window)){
  ...
  App.speechCommand('go to',{
    action: function(){
      ...
      image: '/resource/index/cleanzone/images/bubble-tail.png',
      class_name: 'clean',
      time: ''
      });          
    },
    listen: function(datos){
      switch(datos){
        ...
        case "500 page": location.href = "pages-500.html?listen=on"; break;
        default:
          $.gritter.add({title: "Error",text: "Could not find: <strong>" + datos + "</strong> page, Please try again.",image: '/resource/index/cleanzone/images/bubble-tail.png',class_name: 'clean',time: ''});  
        break;
      }
    }
  });
