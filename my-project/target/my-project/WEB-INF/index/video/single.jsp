			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<ul class="list-inline top-link link">
						<li><a href="/welcome/index"><i class="fa fa-home"></i> Home</a></li>
						<li><a href="/welcome/contact"><i class="fa fa-comments"></i> Contact</a></li>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="/welcome/contact"><i class="fa fa-envelope"></i> Contact</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="container">
			<div class="row">
				<div id="main-content" class="col-md-8">
					<div class="wrap-vid">
						<iframe width="100%" height="400" src="http://player.youku.com/embed/XODA3MDIwMzQw" frameborder="0" allowfullscreen></iframe>
					</div>
					<div class="share">
