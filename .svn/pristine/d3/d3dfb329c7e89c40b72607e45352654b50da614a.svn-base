...
<!-- Mirrored from condorthemes.com/cleanzone/typography.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:37:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="/resource/index/cleanzone/js/prettify/prettify.css" />
        ...
        <div class="menu-space">
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li class="active"><a href="typography.html"><i class="fa fa-text-height"></i><span>Typography</span></a></li>
			...
			<div class="row">
					...
					<div class="block-flat">
						<div class="content no-padding">
							<div class="overflow-hidden">
								<i class="fa fa-clock-o fa-4x pull-left color-primary"></i> 
								<h3 class="no-margin">TOTAL VISITS</h3>
								<p class="color-primary">Daily visits average</p>
							</div>
							<h1 class="no-margin big-text">1,350</h1>							
						</div>
					</div>	
				</div>
				<div class="col-md-4">
					<div class="block-flat">
						<div class="content no-padding">
							<div class="overflow-hidden">
								...
								<h3 class="no-margin">INCREASE</h3>
								<p class="color-danger">Sales increase rate</p>
							</div>
							<h1 class="big-text no-margin">30%</h1>							
						</div>
					</div>	
				</div>
				<div class="col-md-4">
					<div class="block-flat">
						<div class="content no-padding">
							<div class="overflow-hidden">
								<i class="fa fa-random fa-4x pull-left color-success"></i> 
								<h3 class="no-margin">EARNINGS</h3>
								<p class="color-success">Week earning average</p>
							</div>
							<h1 class="big-text no-margin">$ 50</h1>							
						</div>
					</div>	
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-8">
					<div class="block-flat">
						...
						<div class="content overflow-hidden">
							<div class="well">It would seem that these giants spent the earlier part of the afternoon in going to and fro, transferring everything from the second and third cylinders--the second in Addlestone Golf Links and the third at Pyrford--to their original pit on Horsell Common.
							<p class="text-right">H. G. Wells</p></div>
						</div>
					</div>	
				</div>			
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="block-flat">
						...
						<div class="content overflow-hidden">
							<h4>Inline</h4>
							Wrap inline snippets of code with <code>&lt;code&gt;</code>.<br />
...
&lt;/div&gt;				</pre>						
  ...
  <script src="/resource/index/cleanzone/js/jquery.ui/jquery-ui.js" type="text/javascript"></script>
	...
	<script type="text/javascript" src="/resource/index/cleanzone/js/prettify/run_prettify.js"></script>
...
<!-- Mirrored from condorthemes.com/cleanzone/typography.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:37:32 GMT -->
</html>
