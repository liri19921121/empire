...
<!-- Mirrored from condorthemes.com/cleanzone/ui-grid.html by HTTrack Website Copier/3.x [XR&CO'2013], Mon, 31 Mar 2014 14:35:05 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <div id="head-nav" class="navbar navbar-default navbar-fixed-top">
	...
	<div id="cl-wrapper">
		...
		<div class="container-fluid" id="pcont">
			<div class="page-head">
				<button class="btn btn-success btn-lg pull-right" style="margin-top:10px;">Buy Template</button>
				<h2>Grid System</h2>
				<ol class="breadcrumb">
				  <li><a href="#">Home</a></li>
		  ...
		  <div class="cl-mcont">
			...
			<div class="row">			
				...
				<div class="col-sm-6 col-md-6 col-lg-4">
					<div class="block-flat">
						<div class="header">							
							<h3 class="visible-sm visible-md">Col 6</h3>
							<h3 class="visible-lg">Col 4</h3>
							<h3 class="visible-xs">Col 12</h3>
						</div>
						<div class="content">
