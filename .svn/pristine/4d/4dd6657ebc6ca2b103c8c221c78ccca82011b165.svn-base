...
import com.research.wx.config.WXPayConfigImpl;
import com.research.wx.sdk.WXPay;
import com.research.wx.sdk.WXPayUtil;
...
public class TestWXPayPerformance
{
    ...
    public void testUnifiedOrderSpeed()
        throws Exception
    {
    ...
    public void testUnifiedOrderSpeedWithMultiThread()
        throws Exception
    {
    ...
    public void testRefundSpeedWithMultiThread()
        throws Exception
    {
        Runnable task = new Runnable()
        {
